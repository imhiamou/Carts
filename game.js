...
function resize() {
  ...
  const widthRatio = window.innerWidth / WORLD_WIDTH;
  const heightRatio = window.innerHeight / WORLD_HEIGHT;
  ...
  offsetX = (window.innerWidth - WORLD_WIDTH * scaleX) / 2;
  offsetY = ((window.innerHeight - WORLD_HEIGHT * scaleY) / 2) + Y_SHIFT;
...
function draw() {
  ...
  ctx.setTransform(
    window.devicePixelRatio * scaleX,
    0,
    0,
    window.devicePixelRatio * scaleY,
    window.devicePixelRatio * offsetX,
    window.devicePixelRatio * offsetY
  );
